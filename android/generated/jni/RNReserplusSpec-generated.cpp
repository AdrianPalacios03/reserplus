...
NativeReserplusSpecJSI::NativeReserplusSpecJSI(const JavaTurboModule::InitParams &params)
  : JavaTurboModule(params) {
  methodMap_["multiply"] = MethodMetadata {2, __hostFunction_NativeReserplusSpecJSI_multiply};
}

std::shared_ptr<TurboModule> RNReserplusSpec_ModuleProvider(const std::string &moduleName, const JavaTurboModule::InitParams &params) {
  if (moduleName == "Reserplus") {
    return std::make_shared<NativeReserplusSpecJSI>(params);
  }
  return nullptr;
}
